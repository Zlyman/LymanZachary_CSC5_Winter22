 ...
 * Purpose: Average Score Dropping the Lowest 
 */
...
float clacAvg(int,int,int,int,int);
...
int main(int argc, char** argv) {
    ...
    cout<<"The average of the 4 highest scores = "
        <<clacAvg(score1,score2,score3,score4,score5);
    //Exit the program
    return 0;
}

float clacAvg(int s1,int s2,int s3,int s4,int s5){
...
void getScr(int &s1,int &s2,int &s3,int &s4,int &s5){
    ...
    cout<<"The original scores before inputting values are"<<endl;
