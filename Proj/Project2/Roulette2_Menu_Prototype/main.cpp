...
void dpslMnu(float);
void choice(vector <unsigned char>,vector <float>,float,unsigned char);
...
void choice(vector <unsigned char> select,vector <float> bet,float usrBank,unsigned char sel){
    unsigned char s,repeat;
    float b;
    s=sel;
    if(s!='q'&&s!='Q'){
        select.push_back(s);
        ...
        bet.push_back(b);
        cout<<"Would you like to place another bet Y/N?"<<endl;
        cin>>repeat;
        ...
        while(repeat!='n'&&repeat!='N'){
            ...
            cin>>s;
            while(s=='q'||s=='Q'){
                cout<<"Please finish your bet in progress"<<endl;
                cout<<"Input new selection"<<endl;
                cin>>s;
            }
            select.push_back(s);
            cout<<"Input your bet in dollars$$$$$"<<endl;
